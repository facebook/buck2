...
def cxx_dist_link(
    ...
    def dynamic_plan(link_plan: Artifact, index_argsfile_out: Artifact, final_link_index: Artifact):
        def plan(ctx: AnalysisContext, artifacts, _, outputs):
            # buildifier: disable=uninitialized
    ...
    def dynamic_optimize(name: str, initial_object: Artifact, bc_file: Artifact, plan: Artifact, opt_object: Artifact):
        def optimize_object(ctx: AnalysisContext, artifacts, _, outputs):
    ...
    def dynamic_optimize_archive(archive: _ArchiveLinkData):
        def optimize_archive(ctx: AnalysisContext, artifacts, _, outputs):
    ...
    def thin_lto_final_link(ctx: AnalysisContext, artifacts, _, outputs):
