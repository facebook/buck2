...
load("@prelude//apple/swift:swift_compilation.bzl", "extract_sdk_swiftmodule_linkables", "extract_swiftmodule_linkables", "get_sdk_swiftmodule_linker_flags", "get_swiftmodule_linker_flags")
...
load(
    ...
    "merge_sdk_swiftmodule_linkables",
...
def apple_build_link_args_with_deduped_flags(
    ...
    sdk_swiftmodule_linkables = [x.sdk_swiftmodules[link_strategy] for x in deps_merged_link_infos] + [sdk_swiftmodule_linkable]
...
def apple_get_link_info_by_deduping_link_infos(
    ...
    sdk_swiftmodule_linkables = extract_sdk_swiftmodule_linkables(infos)
    sdk_swiftmodule_linkables.append(sdk_swiftmodule_linkable)

    return _apple_link_info_from_linkables(ctx, framework_linkables, swiftmodule_linkables, sdk_swiftmodule_linkables, swift_runtime_linkables)
...
def _apple_link_info_from_linkables(
        ...
        sdk_swiftmodule_linkables: list[[SdkSwiftmoduleLinkable, None]] = [],
    ...
    sdk_swift_module_link_args = get_sdk_swiftmodule_linker_flags(ctx, merge_sdk_swiftmodule_linkables(ctx, sdk_swiftmodule_linkables))

    return LinkInfo(
        pre_flags = [framework_link_args, swift_module_link_args, swift_runtime_link_args, sdk_swift_module_link_args],
    ) if (framework_link_args or swift_module_link_args or swift_runtime_link_args or sdk_swift_module_link_args) else None
