...
def prebuilt_jar_impl(ctx: AnalysisContext) -> list[Provider]:
    ...
    output = ctx.actions.declare_output("symlink/{}".format(binary_jar.short_path), uses_experimental_content_based_path_hashing = ctx.attrs.uses_content_based_paths)
