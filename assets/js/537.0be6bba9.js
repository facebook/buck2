...
/* harmony export */ });
/* harmony import */ var _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(36212);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(26312);
/* harmony import */ var _createText_2e5e7dd3_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(37295);
...
/* harmony export */ });
/* harmony import */ var _flowDb_956e92f1_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(35860);
...
/* harmony import */ var _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(36212);
...
/* harmony import */ var _styles_c10674c1_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(35900);
...
const addVertices = async function(vert, g, svgId, root, _doc, diagObj) {
  ...
  for (const id of keys) {
    ...
    const styles = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.k)(vertex.styles);
    let vertexText = vertex.text !== void 0 ? vertex.text : vertex.id;
    let vertexNode;
    if ((0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.m)((0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.c)().flowchart.htmlLabels)) {
      const node = {
        label: await (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.r)(
          vertexText.replace(
            /fa[blrs]?:fa-[\w-]+/g,
            // cspell:disable-line
            (s) => `<i class='${s.replace(":", " ")}'></i>`
          ),
          (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.c)()
        )
      };
      ...
      const rows = vertexText.split(_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.e.lineBreakRegex);
      for (const row of rows) {
    ...
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.l.warn("Adding node", vertex.id, vertex.domId);
...
const addEdges = async function(edges, g, diagObj) {
  ...
  if (edges.defaultStyle !== void 0) {
    const defaultStyles = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.k)(edges.defaultStyle);
  ...
  for (const edge of edges) {
    ...
    if (edge.style !== void 0) {
      const styles = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.k)(edge.style);
      style = styles.style;
      labelStyle = styles.labelStyle;
    } else {
      switch (edge.stroke) {
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.n)(edge.interpolate, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.n)(edges.defaultInterpolate, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    } else {
      edgeData.curve = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.n)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
      ...
      if ((0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.m)((0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.c)().flowchart.htmlLabels)) {
        ...
        edgeData.label = `<span id="L-${linkId}" class="edgeLabel L-${linkNameStart}' L-${linkNameEnd}" style="${edgeData.labelStyle}">${await (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.r)(
          edge.text.replace(
            /fa[blrs]?:fa-[\w-]+/g,
            // cspell:disable-line
            (s) => `<i class='${s.replace(":", " ")}'></i>`
        ...
        edgeData.label = edge.text.replace(_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.e.lineBreakRegex, "\n");
        if (edge.style === void 0) {
...
const getClasses = function(text, diagObj) {
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.l.info("Extracting classes");
  return diagObj.db.getClasses();
};
const draw = async function(text, id, _version, diagObj) {
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.l.info("Drawing flowchart");
  const { securityLevel, flowchart: conf2 } = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  let sandboxElement;
  ...
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.l.warn("Get vertices", vert);
  ...
  for (i = subGraphs.length - 1; i >= 0; i--) {
    ...
    for (let j = 0; j < subG.nodes.length; j++) {
      _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.l.warn(
        "Setting subgraph",
        subG.nodes[j],
  ...
  (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_10__.o)(g, svg, conf2.diagramPadding, conf2.useMaxWidth);
  const keys = Object.keys(vert);
...
const diagram = {
  parser: _flowDb_956e92f1_js__WEBPACK_IMPORTED_MODULE_13__.p,
  db: _flowDb_956e92f1_js__WEBPACK_IMPORTED_MODULE_13__.f,
  renderer: _styles_c10674c1_js__WEBPACK_IMPORTED_MODULE_14__.f,
  styles: _styles_c10674c1_js__WEBPACK_IMPORTED_MODULE_14__.a,
  init: (cnf) => {
    if (!cnf.flowchart) {
      cnf.flowchart = {};
    }
    ...
    _flowDb_956e92f1_js__WEBPACK_IMPORTED_MODULE_13__.f.clear();
    _flowDb_956e92f1_js__WEBPACK_IMPORTED_MODULE_13__.f.setGen("gen-1");
  }
};
...
/* harmony import */ var _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(36212);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(697);
/* harmony import */ var _createText_2e5e7dd3_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(37295);
...
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(697);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(26312);
/* harmony import */ var _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(36212);
