...
def _transition_opt_by_default_impl(platform: PlatformInfo, refs: struct) -> PlatformInfo:
    constraints = platform.configuration.constraints
    opt_by_default_key = refs._opt_by_default__enabled[ConstraintValueInfo].setting.label
    ...
    if opt_by_default_key not in constraints or constraints[opt_by_default_key].label != refs._opt_by_default__enabled[ConstraintValueInfo].label:
        return platform
