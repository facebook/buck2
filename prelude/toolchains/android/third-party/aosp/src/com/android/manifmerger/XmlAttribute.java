...
public class XmlAttribute extends XmlNode {
    ...
    private void handleBothAttributePresent(
        ...
        // the attribute is present on both elements, there are 3 possibilities :
        // 1. tools:replace was specified, replace the value.
        // 2. nothing was specified, the values should be equal or this is an error.
        // 3. QVT related violationType attributes can be ignored.
        ...
        // ignore QVT added attributes; they are only for testing, not building
        if (mXml.getName() == "violationExplanation") {
            return;
        }
