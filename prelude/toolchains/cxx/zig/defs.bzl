...
def _zig_distribution_impl(ctx: AnalysisContext) -> ["provider"]:
...
def _http_archive_impl(ctx: AnalysisContext) -> ["provider"]:
...
def _cxx_zig_toolchain_impl(ctx: AnalysisContext) -> ["provider"]:
