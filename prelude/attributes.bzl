# @generated SignedSource<<9d7d85ab9a5ce33678431e0c71e04195>>
...
attributes = {
    ...
    "rust_binary": {
        ...
        "platform_linker_flags": attrs.list(attrs.tuple(attrs.regex(), attrs.list(attrs.arg())), default = []),
        "platform_rustc_flags": attrs.option(attrs.one_of(attrs.list(attrs.tuple(attrs.regex(), attrs.list(attrs.arg()))), attrs.dict(key = attrs.string(), value = attrs.list(attrs.arg()), sorted = True)), default = None),
