...
def _rust_artifacts(
    ...
    compile_ctx: CompileContext,
    lang_style_param: dict[(LinkageLang, LibOutputStyle), BuildParams],
    param_metadata_outputs: dict[BuildParams, dict[MetadataKind, RustcOutput | None]],
...
def _handle_rust_artifact(
    ctx: AnalysisContext, dep_ctx: DepCollectionContext, link_strategy: LinkStrategy, outputs: dict[MetadataKind, RustcOutput | None]
) -> RustLinkStrategyInfo:
    """
