...
@buck_test(inplace=False, data_dir="include_external")
...
@buck_test(inplace=False, data_dir="empty", skip_for_os=["windows"])
...
@buck_test(inplace=False, data_dir="empty")
...
@buck_test(inplace=False, data_dir="include_through_symlink")
