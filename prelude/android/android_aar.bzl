...
def android_aar_impl(ctx: AnalysisContext) -> list[Provider]:
    ...
    resource_infos = list(android_packageable_info.resource_infos.traverse())
    ...
    entries = [android_manifest, classes_jar, merged_resource_sources_dir, r_dot_txt] + assets_dirs
