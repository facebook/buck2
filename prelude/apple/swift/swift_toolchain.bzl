...
def swift_toolchain_impl(ctx):
    ...
    return [
        ...
        SwiftToolchainInfo(
            ...
            prioritize_swift_critical_path = ctx.attrs.prioritize_swift_critical_path,
            ...
            supports_modularization_dependency_graph = ctx.attrs.supports_modularization_dependency_graph,
