...
/* harmony export */   C: () => (/* binding */ intersectRect)
/* harmony export */ });
...
var intersect_polygon = __webpack_require__(17446);
// EXTERNAL MODULE: ./node_modules/dagre-d3-es/src/dagre-js/intersect/intersect-rect.js
var intersect_rect = __webpack_require__(84113);
...
function rect(parent, bbox, node) {
  ...
  node.intersect = function (point) {
    return (0,intersect_rect/* intersectRect */.C)(node, point);
  };
...
function diamond(parent, bbox, node) {
  ...
  node.intersect = function (p) {
    return (0,intersect_polygon/* intersectPolygon */.k)(node, points, p);
  };
...
/* harmony export */ });
/* harmony import */ var _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(94384);
/* harmony import */ var mdast_util_from_markdown__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1729);
/* harmony import */ var ts_dedent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(60513);



function preprocessMarkdown(markdown) {
  const withoutMultipleNewlines = markdown.replace(/\n{2,}/g, "\n");
  const withoutExtraSpaces = (0,ts_dedent__WEBPACK_IMPORTED_MODULE_0__/* .dedent */ .T)(withoutMultipleNewlines);
  return withoutExtraSpaces;
}
function markdownToLines(markdown) {
  const preprocessedMarkdown = preprocessMarkdown(markdown);
  const { children } = (0,mdast_util_from_markdown__WEBPACK_IMPORTED_MODULE_1__/* .fromMarkdown */ .Y)(preprocessedMarkdown);
  const lines = [[]];
  let currentLine = 0;
...
function markdownToHTML(markdown) {
  const { children } = (0,mdast_util_from_markdown__WEBPACK_IMPORTED_MODULE_1__/* .fromMarkdown */ .Y)(markdown);
...
const createText = (el, text = "", {
  ...
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.l.info("createText", text, style, isTitle, classes, useHtmlLabels, isNode, addSvgBackground);
  if (useHtmlLabels) {
    const htmlText = markdownToHTML(text);
    const node = {
      isNode,
      label: (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__.M)(htmlText).replace(
        /fa[blrs]?:fa-[\w-]+/g,
        // cspell: disable-line
...
/* harmony export */ });
/* harmony import */ var _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(94384);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(26312);
/* harmony import */ var _createText_4a4f35c9_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(70213);
...
/* harmony export */ });
/* harmony import */ var _flowDb_0da60e67_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(98688);
...
/* harmony import */ var _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(94384);
/* harmony import */ var dagre_d3_es__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(43709);
/* harmony import */ var dagre_d3_es_src_dagre_js_util_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(82933);
/* harmony import */ var dagre_d3_es_src_dagre_js_label_add_html_label_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(10646);
...
/* harmony import */ var dagre_d3_es_src_dagre_js_intersect_intersect_rect_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(84113);
/* harmony import */ var _styles_422bd1c9_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(23222);
...
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(21176);
/* harmony import */ var dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(14075);
...
function question(parent, bbox, node) {
  ...
  node.intersect = function(point) {
    return (0,dagre_d3_es_src_dagre_js_intersect_intersect_polygon_js__WEBPACK_IMPORTED_MODULE_8__/* .intersectPolygon */ .k)(node, points, point);
  };
  return shapeSvg;
}
...
function stadium(parent, bbox, node) {
  ...
  node.intersect = function(point) {
    return (0,dagre_d3_es_src_dagre_js_intersect_intersect_rect_js__WEBPACK_IMPORTED_MODULE_9__/* .intersectRect */ .C)(node, point);
  };
  return shapeSvg;
}
...
function cylinder(parent, bbox, node) {
  ...
  node.intersect = function(point) {
    const pos = (0,dagre_d3_es_src_dagre_js_intersect_intersect_rect_js__WEBPACK_IMPORTED_MODULE_9__/* .intersectRect */ .C)(node, point);
    const x = pos.x - node.x;
    if (rx != 0 && (Math.abs(x) < node.width / 2 || Math.abs(x) == node.width / 2 && Math.abs(pos.y - node.y) > node.height / 2 - ry)) {
      let y = ry * ry * (1 - x * x / (rx * rx));
      if (y != 0) {
...
const addVertices = async function(vert, g, svgId, root, _doc, diagObj) {
  const svg = !root ? (0,d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .Ltv)(`[id="${svgId}"]`) : root.select(`[id="${svgId}"]`);
  ...
  for (const id of keys) {
    ...
    const styles = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.k)(vertex.styles);
    let vertexText = vertex.text !== void 0 ? vertex.text : vertex.id;
    let vertexNode;
    if ((0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.m)((0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.c)().flowchart.htmlLabels)) {
      const node = {
        label: await (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.r)(
          vertexText.replace(
            /fa[blrs]?:fa-[\w-]+/g,
            // cspell:disable-line
            (s) => `<i class='${s.replace(":", " ")}'></i>`
          ),
          (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.c)()
        )
      };
      vertexNode = (0,dagre_d3_es_src_dagre_js_label_add_html_label_js__WEBPACK_IMPORTED_MODULE_11__/* .addHtmlLabel */ .H)(svg, node).node();
      vertexNode.parentNode.removeChild(vertexNode);
    } else {
      const svgLabel = doc.createElementNS("http://www.w3.org/2000/svg", "text");
      svgLabel.setAttribute("style", styles.labelStyle.replace("color:", "fill:"));
      const rows = vertexText.split(_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.e.lineBreakRegex);
      for (const row of rows) {
    ...
    _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.l.warn("Adding node", vertex.id, vertex.domId);
...
const addEdges = async function(edges, g, diagObj) {
  ...
  if (edges.defaultStyle !== void 0) {
    const defaultStyles = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.k)(edges.defaultStyle);
  ...
  for (const edge of edges) {
    ...
    if (edge.style !== void 0) {
      const styles = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.k)(edge.style);
      style = styles.style;
      labelStyle = styles.labelStyle;
    } else {
      switch (edge.stroke) {
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.n)(edge.interpolate, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.n)(edges.defaultInterpolate, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    } else {
      edgeData.curve = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.n)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
      ...
      if ((0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.m)((0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.c)().flowchart.htmlLabels)) {
        ...
        edgeData.label = `<span id="L-${linkId}" class="edgeLabel L-${linkNameStart}' L-${linkNameEnd}" style="${edgeData.labelStyle}">${await (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.r)(
          edge.text.replace(
            /fa[blrs]?:fa-[\w-]+/g,
            // cspell:disable-line
            (s) => `<i class='${s.replace(":", " ")}'></i>`
        ...
        edgeData.label = edge.text.replace(_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.e.lineBreakRegex, "\n");
        if (edge.style === void 0) {
...
const getClasses = function(text, diagObj) {
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.l.info("Extracting classes");
  return diagObj.db.getClasses();
};
const draw = async function(text, id, _version, diagObj) {
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.l.info("Drawing flowchart");
  const { securityLevel, flowchart: conf2 } = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  let sandboxElement;
  ...
  _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.l.warn("Get vertices", vert);
  ...
  for (i = subGraphs.length - 1; i >= 0; i--) {
    ...
    for (let j = 0; j < subG.nodes.length; j++) {
      _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.l.warn(
        "Setting subgraph",
        subG.nodes[j],
  ...
  const render$1 = new dagre_d3_es__WEBPACK_IMPORTED_MODULE_2__/* .render */ .XX();
  flowChartShapes.addToRender(render$1);
  render$1.arrows().none = function normal(parent, id2, edge, type) {
    const marker = parent.append("marker").attr("id", id2).attr("viewBox", "0 0 10 10").attr("refX", 9).attr("refY", 5).attr("markerUnits", "strokeWidth").attr("markerWidth", 8).attr("markerHeight", 6).attr("orient", "auto");
    const path = marker.append("path").attr("d", "M 0 0 L 0 0 L 0 0 z");
    (0,dagre_d3_es_src_dagre_js_util_js__WEBPACK_IMPORTED_MODULE_12__/* .applyStyle */ .AV)(path, edge[type + "Style"]);
  };
  ...
  for (i = 0; i < subGraphs.length; i++) {
    ...
    if (subG.title !== "undefined") {
      ...
      const cluster = (0,d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .Ltv)(clusterEl[0]);
  ...
  (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_10__.o)(g, svg, conf2.diagramPadding, conf2.useMaxWidth);
  const keys = Object.keys(vert);
...
const diagram = {
  parser: _flowDb_0da60e67_js__WEBPACK_IMPORTED_MODULE_13__.p,
  db: _flowDb_0da60e67_js__WEBPACK_IMPORTED_MODULE_13__.f,
  renderer: _styles_422bd1c9_js__WEBPACK_IMPORTED_MODULE_14__.f,
  styles: _styles_422bd1c9_js__WEBPACK_IMPORTED_MODULE_14__.a,
  init: (cnf) => {
    if (!cnf.flowchart) {
      cnf.flowchart = {};
    }
    ...
    _flowDb_0da60e67_js__WEBPACK_IMPORTED_MODULE_13__.f.clear();
    _flowDb_0da60e67_js__WEBPACK_IMPORTED_MODULE_13__.f.setGen("gen-1");
  }
};
...
/* harmony import */ var _edges_5962ec63_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(68096);
/* harmony import */ var _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(94384);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(697);
/* harmony import */ var _createText_4a4f35c9_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(70213);
...
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(26312);
/* harmony import */ var _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(94384);
/* harmony import */ var _index_9620d214_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(13265);
