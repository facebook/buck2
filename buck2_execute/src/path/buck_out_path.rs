...
impl BaseDeferredKey {
    fn as_path(&self) -> ForwardRelativePathBuf {
        match self {
            ...
            BaseDeferredKey::BxlLabel(key) => ForwardRelativePathBuf::concat([
                ForwardRelativePath::unchecked_new("__bxl__"),
                ForwardRelativePath::unchecked_new(key.label().bxl_path.cell().as_str()),
                key.label()
                    .bxl_path
                    .path()
                    .path()
