...
def go_list_stdlib(actions: AnalysisActions, go_toolchain: GoToolchainInfo, cgo_enabled: bool) -> Artifact:
    ...
    go_list_args = [
        ...
        "--convert-json-stream",
        "list",
        "-json=ImportPath,ImportMap,EmbedFiles,Name,Imports,GoFiles,HFiles,CFiles,CXXFiles,MFiles,CgoFiles,SFiles,SysoFiles,CgoCFLAGS,CgoCPPFLAGS,CgoCXXFLAGS,CgoLDFLAGS,IgnoredGoFiles,IgnoredOtherFiles,EmbedPatterns",
...
def parse_go_list_stdlib_out(goroot: Artifact, go_list: dict) -> StdGoListOut:
    ...
    return StdGoListOut(
        ...
        go_list = GoListOut(
            ...
            m_files = project_files(go_list.get("MFiles", [])),
