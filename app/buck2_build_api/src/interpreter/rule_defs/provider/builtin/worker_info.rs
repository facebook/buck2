...
fn worker_info_creator(globals: &mut GlobalsBuilder) {
    ...
    fn WorkerInfo<'v>(
        ...
        #[starlark(require = named, default = false)] supports_bazel_remote_persistent_worker_protocol: bool,
        ...
        Ok(WorkerInfo {
            ...
            supports_bazel_remote_persistent_worker_protocol: heap.alloc_typed_unchecked(supports_bazel_remote_persistent_worker_protocol).cast(),
        })
    }
}
