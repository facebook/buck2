...
def get_apple_dsym(ctx: AnalysisContext, executable: "artifact", debug_info: list[AppleDebugInfo], action_identifier: "string", output_path_override: ["string", None] = None) -> "artifact":
...
# - oso_prefix
# - dsym_verification
def get_apple_dsym_ext(ctx: AnalysisContext, executable: ["_arglike", "artifact"], debug_info: list[AppleDebugInfo], action_identifier: "string", output_path: "string") -> "artifact":
