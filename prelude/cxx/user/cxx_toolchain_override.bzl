...
def _cxx_toolchain_override_inheriting_target_platform_attrs():
    return {
        ...
        "as_compiler": attrs.option(attrs.dep(providers = [RunInfo]), default = None),
        ...
        "base": attrs.dep(providers = [CxxToolchainInfo]),
        "bolt_enabled": attrs.option(attrs.bool(), default = None),
        "c_compiler": attrs.option(attrs.dep(providers = [RunInfo]), default = None),
        ...
        "cxx_compiler": attrs.option(attrs.dep(providers = [RunInfo]), default = None),
        ...
        "mk_comp_db": attrs.option(attrs.dep(providers = [RunInfo]), default = None),
        "mk_hmap": attrs.option(attrs.dep(providers = [RunInfo]), default = None),
        "mk_shlib_intf": attrs.option(attrs.dep(providers = [RunInfo]), default = None),
        "nm": attrs.option(attrs.dep(providers = [RunInfo]), default = None),
        "objcopy": attrs.option(attrs.dep(providers = [RunInfo]), default = None),
        ...
        "strip": attrs.option(attrs.dep(providers = [RunInfo]), default = None),
