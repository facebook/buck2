    ...
    'v + ProvidesStaticType<'v> + Allocative + Debug + Display + Serialize + Sized
{
    ...
    type Canonical: StarlarkValue<'v> = crate::values::types::not_type::NotType;
    ...
    /// Whether this type implements `invoke`.
    /// This member is generated by the `#[starlark_value]` macro.
    const HAS_INVOKE: bool = false;
    ...
    /// Whether this type implements `at`.
    /// This member is generated by the `#[starlark_value]` macro.
    const HAS_AT: bool = false;
    ...
    /// Whether this type implements `plus`.
    /// This member is generated by the `#[starlark_value]` macro.
    const HAS_PLUS: bool = false;
    ...
    /// Whether this type implements `minus`.
    /// This member is generated by the `#[starlark_value]` macro.
    const HAS_MINUS: bool = false;
    ...
    /// Whether this type implements `bit_not`.
    /// This member is generated by the `#[starlark_value]` macro.
    const HAS_BIT_NOT: bool = false;
