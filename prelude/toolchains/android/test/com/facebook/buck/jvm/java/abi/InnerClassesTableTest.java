  ...
  public void findsInnerClassReferencesInClassTypeParameters() throws IOException {
    tester
        .setSourceFile(
            "A.java",
            "package com.example.buck;",
            "public class A<T extends TopLevel.MemberInterface & TopLevel.MemberInterface2, U, V"
                + " extends TopLevel.StaticMember> { }")
        .expectInnerClassesTable(
            "com.example.buck.A",
            "com/example/buck/TopLevel$MemberInterface",
            "com/example/buck/TopLevel$MemberInterface2",
  ...
  public void findsInnerClassReferencesInMethodTypeParameters() throws IOException {
    tester
        .setSourceFile(
            ...
            "package com.example.buck;",
            "public class A {",
            "  <T extends TopLevel.MemberInterface & TopLevel.MemberInterface2, U, V extends"
                + " TopLevel.StaticMember> void foo(T t, U u, V v) { }",
            "}")
        .expectInnerClassesTable(
            "com.example.buck.A",
            "com/example/buck/TopLevel$MemberInterface",
  ...
  public void findsInnerClassReferencesInParameterType() throws IOException {
    tester
        .setSourceFile(
            ...
            "package com.example.buck;",
            "public class A {",
            "  void foo(TopLevel.StaticMember param1, TopLevel.MemberInterface param2,"
                + " TopLevel.MemberInterface2 param3) {}",
            "}")
        .expectInnerClassesTable(
            "com.example.buck.A",
            "com/example/buck/TopLevel$MemberInterface",
    ...
    public void expectInnerClassesTable(String className, String... innerClassesEntries)
      ...
      compiler.addClasspathFileContents(
          ...
          "  @Target({ElementType.PACKAGE, ElementType.TYPE, ElementType.METHOD,"
              + " ElementType.PARAMETER, ElementType.FIELD, ElementType.TYPE_PARAMETER})",
