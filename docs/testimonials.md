...
Abishek and Tianyu moved [iOS Target Determinator](https://fb.workplace.com/groups/699515261107923/posts/799245711134877) to Buck2:

> Moving to Buck2 has accounted for 40-50% performance wins.

Lydia and others moved some [Ads ML builds](https://fb.workplace.com/groups/138621250188338/posts/1135695127147607/) to Buck2 and enabled distributed ThinLTO:

> This helped us improve the avg build time by 50%~60% (equivalent to saving 52.15 hours of build time/day based on the number of builds)
