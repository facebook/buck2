...
const db = {
  nodesMap,
  getConfig: () => (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_4__.c)().sankey,
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
const draw = function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_4__.c)();
  const defaultSankeyConfig = _mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_4__.K.sankey;
  let sandboxElement;
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
  ...
  (0,_mermaid_2490e8f2_js__WEBPACK_IMPORTED_MODULE_4__.o)(void 0, svg, 0, useMaxWidth);
};
const renderer = {
  draw
};
