...
def alias_impl(ctx: AnalysisContext) -> ["provider"]:
    return ctx.attrs.actual.providers

def configured_alias_impl(ctx: AnalysisContext) -> ["provider"]:
...
def versioned_alias_impl(_ctx: AnalysisContext) -> ["provider"]:
