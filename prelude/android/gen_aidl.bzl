...
def gen_aidl_impl(ctx: "context") -> ["provider"]:
    ...
    jar_cmd.add("-cfM")
    out = ctx.actions.declare_output("{}_aidl_java_output.src.zip".format(ctx.attr.name))
